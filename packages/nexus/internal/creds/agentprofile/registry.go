...
// Profile describes an AI agent's credentials and configuration.
type Profile struct {
	Name         string
	Aliases      []string
	Binary       string
...
// Lookup returns a Profile by name or alias (case-insensitive).
...
// AllBinaries returns the binary names for all registered profiles.
...
// AllCredFiles returns a deduplicated list of credential file paths.
...
// AllInstallPkgs returns a deduplicated list of install package names.
