...
// Build builds a credential bundle from the current user's home directory.
...
// BuildFromHome builds a base64-encoded gzipped tar of credential files under home.
