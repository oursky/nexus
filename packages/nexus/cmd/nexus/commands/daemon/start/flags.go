...
func registerStartFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&workDirRoot, "workdir-root", "", "Libkrun instance root: workspace VMs, per-repo bases/, and .nexus-vm templates all live under this directory (default: /data/nexus/default when /data/nexus exists). Use a sibling dir per daemon instance (e.g. /data/nexus/e2e).")
